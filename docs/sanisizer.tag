...
<tagfile doxygen_version="1.12.0">
  ...
  <compound kind="page">
    <name>index</name>
    <title>Sanitize sizes to avoid integer overflow</title>
    <filename>index.html</filename>
    <docanchor file="index.html" title="Sanitize sizes to avoid integer overflow">md__2github_2workspace_2README</docanchor>
  </compound>
</tagfile>
